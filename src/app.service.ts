...
export class AppService {
  ...
  async getAiReply(): Promise<string> {
    const _aiInferenceModelName = `orca-mini-3b-gguf2-q4_0.gguf`; // `mistral-7b-openorca.gguf2.Q4_0.gguf`, // 'orca-mini-3b-gguf2-q4_0.gguf'
  ...
  Given the video's transcript above, please generate a summary. The answer should be no more than 50 words.
      `;
